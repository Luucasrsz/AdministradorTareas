        ...
        setContent {
            AdministradorTareasTheme {
                ...
                Surface(
                    ...
                    MostrarVerificado(
                        stringResource(R.string.textoGrande),
                        stringResource(R.string.textoPequeno)
                    )
                }
            }
        }
...
@Composable
fun MostrarVerificado(textoGrande: String, textoPequeno: String, modifier: Modifier = Modifier) {
